...
def _make_detr(backbone_name: str, num_classes: int, dilation=False, mask=False):
    hidden_dim = 256
...
def detr_resnet50(num_classes: int, pretrained=False, return_postprocessor=False):
    """
